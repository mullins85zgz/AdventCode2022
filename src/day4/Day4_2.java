...
public class Day4_2 {
    ...
    public static int getOverlap(String[] pares, int posicion){
        int unusedElves=0;
        ...
        for(int i= 0; i < pares.length;i++){
            ...
            if(i!=posicion){
                ...
                if(parteBajaCompara>=parteBaja && parteBajaCompara<=parteAlta)
                    unusedElves++;
            }
        }

        if(posicion<pares.length-1){
            unusedElves+= getOverlap(pares,++posicion);
        }
